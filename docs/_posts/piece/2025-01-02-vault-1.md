...
<img src="/images/posts/piece/2025-01-02-vault-1/IMG_0035.png" width="360" alt="Circuit Box" />

<img src="/images/posts/piece/2025-01-02-vault-1/IMG_0038.png" width="360" alt="Right Rails" />
...
A Vault is structurally based on truck "Tool Boxes".  Vault-1 is an aluminum 17"x18"x30" (depth-height-width) underbody toolbox and specifically this product: [Arksen 192928026887](https://www.amazon.com/dp/B08SCPBJP6)
...
The floor is 1½" XPS and ½" plywood to raise up the system base to the lower lip edge.  Using XPS under the plywood provides a modest temperature and moisture barrier against the cold ground that the vault could be resting on and any condensation that might accumulate and drip downward. 

The walls are ½" plywood to provide sufficient strength when sandwiched with the tool box aluminum and the outside 'rails' (see below).  On their own, the side walls do not have sufficient tear-out strength for hanging shelves, but when they are structurally laminated with ¾" plywood the total strength is more than enough to hold 100lbs (45 kgs) on a full-width shelf.
...
The outside is framed with 'rails': either redwood or cedar planks that will be bolted with ⅜" bolts through the aluminum to the inside.  The advantages of using rails are:
   ...
   * The inside wall becomes the primary stencil/template for the system and misalignments can be avoided.  A rail has only two holes, so it is easy to have each rail agree with the corresponding holes on the inside wall frame.
   * Esthetically attractive and sturdy

### [Connecting the inside to the outside](#connecting-the-inside-to-the-outside)

A vault build uses stencils to have positions pilot-drilled onto other pieces so alignments match.  The core stenciling is done using the inner walls as the 'jigs': the inner walls have pilots that will be applied to the tool box walls and the outer rails before those pilots are cannibalized to the proper dimensions for the inner wall itself.

The most important aspect for this is to make sure the precision of the stencil-jigs is sufficient for aligning and drilling other pieces.  This precision goes from:
   * ⅛" 'Narwhal' pilots
   * ¼" 'Arbor' pilots
...
The appropriate pilot is used with the inner-wall jig to transfer the template onto the corresponding surface, and then that target surface is drilled using the pilot. 
...
#### [Historic Template](#historic-template)
...
#### [Ultimate Schematic ](#ultimate-schematic)
...
<img src="/images/posts/piece/2025-01-02-vault-1/Kwhik_PergVault_mlf260719_c16_cvs1_19_Page_01.png" width="720" alt="Outdoor Electrical Box" />
...
<img src="/images/posts/piece/2025-01-02-vault-1/Kwhik_PergVault_mlf260719_c16_cvs1_19_Page_15.png" width="720" alt="Base Tool Box dimensions" />

### [Subfloors and Inner Walls](#subfloors-and-inner-walls)

A subfloor of 1.5" XPS is used to provide some amount of insulation from the ground and also to lift the functional floor up to the height of the neck (about 2" up).  Vault-1 has no serious insulation, but this subfloor will be an integral part of insulating Vault-4 and similar R-value vaults.

The following shows the subfloor in lime ('li') spanning the whole bottom as two pieces (side-to-side).  Dividing it into to pieces enables fitting it through the neck and laying it down more easily.  The subfloor may be able to be one piece depending on the actual vault dimensions and neck constraint.  It is also possible with XPS to have it compress to fit and be sure there are no gaps.  A second subfloor is placed on top of the first subfloor, so any minimal gaps will be cross-covered by that second flooring.

<img src="/images/posts/piece/2025-01-02-vault-1/Kwhik_PergVault_mlf260719_c16_cvs1_19_Page_14.png" width="720" alt="Subfloor-1" />
...
<img src="/images/posts/piece/2025-01-02-vault-1/Kwhik_PergVault_mlf260719_c16_cvs1_19_Page_13.png" width="720" alt="Inner Walls" />
...
<img src="/images/posts/piece/2025-01-02-vault-1/Kwhik_PergVault_mlf260719_c16_cvs1_19_Page_12.png" width="720" alt="Subfloor-2" />
...
<img src="/images/posts/piece/2025-01-02-vault-1/Kwhik_PergVault_mlf260719_c16_cvs1_19_Page_11.png" width="720" alt="Outer Rails" />
...
The Tie-Bolts shown in red ('re') connect the outside rails to the inside walls, sandwiching the toolbox aluminum wall between them.  These are positioned 3" from each edge [only 2" from the top as a space optimization]:
...
It is possible to tweak these numbers as needed given the clearance for the ⅜" bolts don't need to be this large, but it produces esoteric variations that won't work with other builds (especially Vault-4 that has very tight contraints).

Note that the shown tie-bolt ('re') blocks include space for heads, nuts, and washers and are not the bolt clearance diameter (see Penetrations below).

<img src="/images/posts/piece/2025-01-02-vault-1/Kwhik_PergVault_mlf260719_c16_cvs1_19_Page_10.png" width="720" alt="Tie-Bolts" />
...
<img src="/images/posts/piece/2025-01-02-vault-1/Kwhik_PergVault_mlf260719_c16_cvs1_19_Page_09.png" width="720" alt="Inner Fittings" />
...
<img src="/images/posts/piece/2025-01-02-vault-1/Kwhik_PergVault_mlf260719_c16_cvs1_19_Page_08.png" width="720" alt="Penetrations" />
...
<img src="/images/posts/piece/2025-01-02-vault-1/Kwhik_PergVault_mlf260719_c16_cvs1_19_Page_07.png" width="720" alt="Inner Shelving" />
...
<img src="/images/posts/piece/2025-01-02-vault-1/Kwhik_PergVault_mlf260719_c16_cvs1_19_Page_06.png" width="720" alt="Support Shelf" />
...
<img src="/images/posts/piece/2025-01-02-vault-1/Kwhik_PergVault_mlf260719_c16_cvs1_19_Page_05.png" width="720" alt="Junction box" />

<img src="/images/posts/piece/2025-01-02-vault-1/Kwhik_PergVault_mlf260719_c16_cvs1_19_Page_04.png" width="720" alt="Junction box" />
...
<img src="/images/posts/piece/2025-01-02-vault-1/Kwhik_PergVault_mlf260719b_c16_cvs21_2_Page_1.png" width="720" alt="Outdoor Electrical Box" />
...
<img src="/images/posts/piece/2025-01-02-vault-1/Kwhik_PergVault_mlf260719b_c16_cvs21_2_Page_2.png" width="720" alt="Outlet Boxes" />

<img src="/images/posts/piece/2025-01-02-vault-1/IMG_0037.png" width="360" alt="Outlet Box" />

## [Summary](#summary)

Finished diagram with all layers.

<img src="/images/posts/piece/2025-01-02-vault-1/Kwhik_PergVault_mlf260719_c16_cvs1_19_Page_01.png" width="720" alt="Finished Diagram" />
