...
As mentioned above, shelf brackets are not directly attached to the inner walls.  Instead, shelf brackets are attached to ¾" support plywood (usually by appropriate screws) and the support plywood is mechanically laminated to the inner wall with ¼" T-nuts and bolts.  Besides space optimization and structural strength advantages, this means the shelf supports can be added (and removed) after the inner walls are put in place.  They can even be tilted so larger components can be slid into the top section at an angle and avoid the top of the neck.
...
<img src="/images/posts/piece/2025-01-02-vault-1/Kwhik_PergVault_mlf260715b_c1_cv32.png" width="720" alt="Inner Shelving" />
